...
响应：
```json
{"mac":"7C:B9:4C:D1:F7:67","name":"433网关","model":"Ai-WB2-12F","sw_version":"1.1.0",
 "entities":[
...
make -j4
# 产物: build_out/example_event_gateway_433.bin
```

## 配置

所有配置在 `example_event_gateway_433/example_event_gateway_433/app_config.h`：
