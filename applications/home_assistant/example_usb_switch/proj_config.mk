...
# Bluetooth used for blufi provisioning; roles match the official blufi example.
CONFIG_BT:=1
CONFIG_BT_CENTRAL:=1
...
#mbedtls hardware crypto (used by blufi security: AES + DH negotiation)
...
LOG_ENABLED_COMPONENTS:=example_usb_switch ha_lib
