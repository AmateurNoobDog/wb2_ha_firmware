...
响应：
```json
{"mac":"7C:B9:4C:D4:5B:0B","name":"USB通断器","model":"Ai-WB2-01S","sw_version":"1.1.0",
 "entities":[
...
make -j4
# 产物: build_out/example_usb_switch.bin
```

## 配置

所有配置在 `example_usb_switch/example_usb_switch/app_config.h`：
