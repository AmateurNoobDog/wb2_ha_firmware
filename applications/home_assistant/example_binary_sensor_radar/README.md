...
响应：
```json
{"mac":"AC:D8:29:7A:60:5D","name":"雷达","model":"RD-01","sw_version":"1.1.0",
 "entities":[
...
make -j6
# 产物: build_out/example_binary_sensor_radar.bin (~589K)
```

## 配置

所有配置在 `example_binary_sensor_radar/example_binary_sensor_radar/app_config.h`:
